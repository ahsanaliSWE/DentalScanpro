...
class YoloVision extends StatefulWidget {
  const YoloVision({Key? key}) : super(key: key);

  @override
  State<YoloVision> createState() => _YoloVisionState();
}

class _YoloVisionState extends State<YoloVision> {
...
class _YoloVideoState extends State<YoloVideo> {
  ...
  Future<void> loadYoloModel() async {
    await widget.vision.loadYoloModel(
        labels: 'assets/labels/labels2.txt',
        modelPath: 'assets/models/yolov8_100.tflite',
        modelVersion: "yolov8",
        numThreads: 2,
        useGpu: true);
    setState(() {
